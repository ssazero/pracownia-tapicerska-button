    ...
    <footer className="footer" ref={props.footerRef}>
      <div className="footer__top">
        <div className="footer__media">
          <a href="tel:+48503658858">
            <FontAwesomeIcon
              icon="mobile-alt"
              className="footer__fa footer__fa--media"
            />
      ...
      <div className="footer__bottom">
        <div className="footer__copyright">
          <span className="footer__copyright-top">
            Button © {new Date().getFullYear()}{" "}
          </span>
          <span className="footer__copyright-middle">
            Autorska Pracownia Tapicerska
          </span>
