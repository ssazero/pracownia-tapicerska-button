...
const Sidebar = (props) => {
  const sidebarContentClasses = ['sidebar__content'];
  const sidebarLogoClasses = ['sidebar__logo-link'];

  if (props.alteration) {
    sidebarContentClasses.push('sidebar__content--alteration');
  }
  if (props.compress) {
    sidebarLogoClasses.push('sidebar__logo-link--compress');
  }

  return (
    <div className='sidebar'>
      <div className={sidebarContentClasses.join(' ')} ref={props.contentRef}>
        <Link className={sidebarLogoClasses.join(' ')} to='/'>
          <img className='sidebar__logo' src='/button-meble-logo.png' alt='logo' />
        </Link>
        <div className='sidebar__media'>
          <div className='sidebar__media-item'>
            <a href='mailto:kontakt@pracownia-button.pl'>
              <FontAwesomeIcon icon='envelope' className='sidebar__fa sidebar__fa--media' />
              <span>kontakt@pracownia-button.pl</span>
            </a>
          </div>
          <div className='sidebar__media-item'>
            <a href='tel:+48503658858'>
              <FontAwesomeIcon icon='mobile-alt' className='sidebar__fa sidebar__fa--media' />
          ...
          <div className='sidebar__media-item'>
            ...
            >
              <FontAwesomeIcon icon='map-marker-alt' className='sidebar__fa sidebar__fa--media' />
              <span>
