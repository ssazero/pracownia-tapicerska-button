      ...
      <article className='offer'>
        ...
        <div className='offer__content'>
          <div className='offer__description'>
            ...
            i&nbsp;rodzinie. Jesteśmy wdzięczni za pokładane w nas zaufanie&nbsp;i zapewniamy, że jakość naszych usług
            stale wzrasta, wciąż podwyższamy poprzeczkę i&nbsp;szlifujemy umiejętności.
          </div>
          <div className='offer__capabilities'>
            <div className='offer__capabilities-item'>
              ...
              <p className='offer__capabilities-item-content'>Odnawiamy i zmieniamy obicia mebli codziennego użytku.</p>
            </div>
            <div className='offer__capabilities-item'>
              <div className='offer__capabilities-item-title'>
                <div className='white-button'>
              ...
              <p className='offer__capabilities-item-content'>
                Produkujemy meble tapicerowane według indywidualnych preferencji klientów - są to produkty jednostkowe -
